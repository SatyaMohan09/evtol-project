    ...
    >
      ...
      <div style={styles.leftPanel}>
        <div style={styles.cameraControls}>
          ...
          <button
            onClick={() => setCameraMode("BOTTOM_CAM")}
            style={{
              ...styles.cameraButton,
              background: "#4fd1c5",
            }}
        ...
        <div style={styles.telemetry}>
          <div style={styles.card}>
            <strong>Pos:</strong> {dronePosition.x.toFixed(1)},{" "}
            {dronePosition.y.toFixed(1)}, {dronePosition.z.toFixed(1)}
          </div>
          <div style={styles.card}>
            <strong>Alt:</strong> {dronePosition.altitude.toFixed(1)} m
          </div>
          <div style={styles.card}>
            <strong>Spd:</strong> {dronePosition.speed.toFixed(1)} m/s
          </div>
          <div style={styles.card}>
            <strong>Dir:</strong> {getHeadingDirection(dronePosition.heading)} (
            {dronePosition.heading.toFixed(0)}°)
          </div>
        </div>
      </div>
